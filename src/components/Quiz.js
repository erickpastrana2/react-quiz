...
const Quiz = () => {
  ...
  //}, []) si teminamos asi solo se hace una vez y son el array vacio se llama en cada render
  ...
  return (
    <div className="quiz">
      ...
      {quizState.questions.length === 0 && !quizState.error && (
        <div>
          <div className="congratulations">No questions available.</div>
        </div>
      )}
    </div>
  );
